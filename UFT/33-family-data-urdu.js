...
const FAMILY_DATA_URDU = [
  ...
  },
  {
    ...
    gen: "G-040-D2",
    gender: "FEMALE",
    details: "سیدہ راضیہ کی شادی تایا ابراہیم کے بیٹے عباس  (کبن) سے ہوئی + دونوں کی جڑ شاہ حسین ہیں - G-038-S1\\n\\nسیدعباس (کبن) اور ان کی اہلیہ راضیہ نے اپنی پُھوپھی سیدہ صابرہ خاتون کے بہٹے سید سعید عباس رضوی (بچھن) کے بیٹے سید جاوید عباس رضوی G-042-S1 کو گود لے لیا تھا"
  },
  {
    name: "سیدہ وجیہہ",
    father: "سید اشفاق حسین",
